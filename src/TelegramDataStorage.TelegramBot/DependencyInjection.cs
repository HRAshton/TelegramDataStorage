...
namespace TelegramDataStorage.TelegramBot;
...
public static class DependencyInjection
{
    ...
    public static IServiceCollection AddTelegramDataStorageForTelegramBot(
        ...
        Action<TelegramDataStorageConfig> config)
    {
        ...
        return services.AddTelegramDataStorageForTelegramBot(configuration);
    }
        ...
        TelegramDataStorageConfig config)
    {
        ...
        return services
            ...
            .AddSingleton<ITelegramBotWrapper, TelegramBotWrapper>();
    }
}